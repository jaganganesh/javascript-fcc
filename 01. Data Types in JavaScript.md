...
`undefined` is a data type that represents a variable that has **been declared but has not been assigned a value**. It means the variable has not been assigned a value yet.
